package com.shopmall.bawei.shopmall1801.product.view;
...
import com.shopmall.bawei.shopcar.shopcar.view.ShopcarActivity;
import com.shopmall.bawei.shopmall1801.R;
import com.shopmall.bawei.shopmall1801.product.contract.ProductDetailContract;
import com.shopmall.bawei.shopmall1801.product.presenter.ProductDetailPresenterImpl;
...
public class ProductDetailActivity extends BaseMVPActivity<ProductDetailPresenterImpl, ProductDetailContract.IProductDetailView> implements ProductDetailContract.IProductDetailView, View.OnClickListener {
    ...
    protected void initPresenter() {
        iHttpPresenter = new ProductDetailPresenterImpl();
    }
    ...
    public void onCheckOneProduct(String productNum) {
        ...
        if (Integer.valueOf(productNum) >=1) { //当前仓库有该商品,把该商品添加到购物车
            ...
            if (checkIfShopcarListHasProduct()) {
                ...
                newNum = oldNum+1;
                iHttpPresenter.updateProductNum(productId,String.valueOf(newNum),productName,url,prodctPrice);
            } else {
                iHttpPresenter.addOneProduct(productId, "1", productName, url, prodctPrice);
            }
        }
    }
    ...
    private void checkHasProduct() {
        iHttpPresenter.checkOneProductNum(productId, "1");//检查仓库是不是还有一件该商品
    }
}
